...
#导入要执行的命令行列表
    ...
    while not q.empty():
        ...
        lock.acquire()   #同步锁
        print('Checking %s ......' %tcping_one)    #必须放在同步锁内，否则有可能乱码,会不按顺序来，无法避免
...
if __name__ == '__main__':
    ...
    print('All finished, pls check "PING Result.xlsx"')
